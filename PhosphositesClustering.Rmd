...
for (i in 1:length(ref)) {
  ...
  heatmap.2(hm, mar = c(7, 10), main = paste0("log2(Mean quan values) of phosphosites in the cluster", el), col=colfunclight(100), cexCol = 0.9, trace = "none", Colv = F, cexRow = 0.35, colsep = c(4, 8, 12, 16, 20), keysize = 1.2, na.color = "grey", na.rm = T, Rowv = F, tracecol = "black", scale = "row")
