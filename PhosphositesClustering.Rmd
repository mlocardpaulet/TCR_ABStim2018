...
```{r, eval = T}
mapping <- data.frame("ClusteringOuptut" = sort(unique(clusres$cluster)), "NewOrdering" = c(12,1:11))
...
g2 <- ggplot(gtab3, aes(x = 0, y = Freq, fill = Var1)) +  geom_bar(width = 1, stat = "identity", position = "fill") + coord_polar("y") + ggtitle("Cluster composition of the regulated pS") + scale_fill_manual(values = colfuncClusters(12)[as.numeric(as.character(gtab3$Var1))]) + theme_minimal() + geom_text_repel(aes(x = 0.5, y = pos, label = Freq), nudge_x = .3, segment.size = .7, show.legend = FALSE)
ggplot(gtab3, aes(x = Var1, y = Freq, fill = Var1)) +  geom_bar(width = 1, stat = "identity", position = "dodge") + ggtitle("Cluster composition of the regulated pS") + scale_fill_manual(values = colfuncClusters(12)[as.numeric(as.character(gtab3$Var1))]) + theme_minimal() #+ facet_wrap(.~facet, scales = "free_x")
kable(gtab3) 
...
g3 <- ggplot(gtab4, aes(x = 0, y = Freq, fill = Var1)) +  geom_bar(width = 1, stat = "identity", position = "fill") + coord_polar("y") + ggtitle("Cluster composition of the regulated pT") + scale_fill_manual(values = colfuncClusters(12)[as.numeric(as.character(gtab4$Var1))]) + theme_minimal() + geom_text_repel(aes(x = 0.5, y = pos, label = Freq), nudge_x = .3, segment.size = .7, show.legend = FALSE)
ggplot(gtab4, aes(x = Var1, y = Freq, fill = Var1)) +  geom_bar(width = 1, stat = "identity", position = "dodge") + ggtitle("Cluster composition of the regulated pT") + scale_fill_manual(values = colfuncClusters(12)[as.numeric(as.character(gtab4$Var1))]) + theme_minimal() #+ facet_wrap(.~facet, scales = "free_x")
kable(gtab4)
