...
```{r, eval = T}
mapping <- data.frame("ClusteringOuptut" = sort(unique(clusres$cluster)), "NewOrdering" = c(8,6,2,1,3,5,9,7,4))
...
**Phospho-tyrosines are over-represented in the clusters 2 and 3: quick and activation and remains up.**
